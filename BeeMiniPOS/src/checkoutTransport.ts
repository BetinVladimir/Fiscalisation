...
export type CheckoutOutcome={operationId:string;route:"REST"|"BLE"|"NONE";state:"COMPLETED"|"ACCEPTED"|"UNKNOWN"|"BLOCKED";fiscalReference?:string;reason?:string;requiredAction?:"RECONCILE"};
export type RouteExecutor=(operationId:string)=>Promise<{state:"COMPLETED"|"ACCEPTED";fiscalReference?:string}>;
...
export type OfflineBinding={tenantId:string;registerId:string;deviceId:string;fencingToken:number};
