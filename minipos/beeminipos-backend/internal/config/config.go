...
func (c Config) Validate() error {
	if c.AppEnv == "prod" && c.SMTPAllowPlaintext {
		return errors.New("SMTP_ALLOW_PLAINTEXT must be false in PROD")
	}
