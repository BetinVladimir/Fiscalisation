...
module.exports = function applyStoreConfig(input) {
  ...
  return {
    ...
    android: { ...config.android, package: id, versionCode: config.android?.versionCode || 1, icon: './store/icon.png', adaptiveIcon: { foregroundImage: './store/adaptive-icon.png', backgroundColor: '#3B221C' } },
