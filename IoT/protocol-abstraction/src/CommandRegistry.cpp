...
const char* canonical(uint16_t code){
 switch(code){
  case 43:return "CreateReversal"; case 45:return "Probe"; case 48:return "OpenFiscalReceipt";
...
RetryClass datecsRetry(uint16_t code){
 const uint16_t read[]={45,50,62,64,65,68,71,74,76,86,87,88,90,99,100,103,110,112,115,116,123,124,125,126,135,140};
