...
Статус: исходный проект алгоритма, без реализации. Дата анализа: 2026-08-11. Упрощённая целевая версия с прямой регистрацией устройства и MQTT transport зафиксирована в [`SMART_DEVICE_MQTT_ACTIVATION_REQUIREMENTS.md`](SMART_DEVICE_MQTT_ACTIVATION_REQUIREMENTS.md) и имеет приоритет при расхождении.
