...
/**
 * Boundary for Datecs FiscalDeviceSDK_MultiPlatform 1.0.1 / Com.Android.Fiscal.
 * The supplied package is a .NET MAUI binding, not an AAR, so production must
 * provide a separately built bridge implementing this contract.
 */
...
class MissingVendorFiscalAdapter : BlueCashFiscalAdapter {
    ...
    override fun executeCanonicalFiscalCommand(command: ByteArray): ByteArray = error("DATECS_FISCAL_VENDOR_BRIDGE_NOT_INSTALLED")
...
class MissingVendorCardAdapter : BlueCashCardAdapter {
    ...
    override fun authorizeEur(amountMinor: Long, operationId: String): Map<String, String> = error("DATECS_PINPAD_VENDOR_BRIDGE_NOT_INSTALLED")
    override fun reverse(operationId: String): Map<String, String> = error("DATECS_PINPAD_VENDOR_BRIDGE_NOT_INSTALLED")
    override fun disconnect() = Unit
}
