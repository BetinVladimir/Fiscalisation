...
export const MVP1_DEVICE_PROFILES: readonly DeviceProfile[] = [
  {
    id: "DATECS_BLUECASH50_EMBEDDED",
    adapter: "BLUECASH_ANDROID",
    fiscal: { vendor: "DATECS", model: "BLUECASH-50", transport: "EMBEDDED" },
    payment: { vendor: "DATECS", model: "BLUECASH-50", transport: "EMBEDDED" },
  },
  {
    id: "DATECS_DP150_BLUEPAD50",
    adapter: "EDGE_AGENT_S3",
    fiscal: { vendor: "DATECS", model: "DP-150 MX", transport: "RS232" },
    payment: {
      vendor: "DATECS",
      model: "BLUEPAD-50 PLUS",
      transport: "BLE_GATT",
    },
  },
  {
    id: "DAISY_COMPACT_S01",
    adapter: "EDGE_AGENT_S3",
    fiscal: { vendor: "DAISY", model: "COMPACT S 01", transport: "USB_SERIAL" },
  },
] as const;
