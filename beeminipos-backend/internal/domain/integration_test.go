...
func TestCheckoutPublicAPIAndReplay(t *testing.T) {
	...
	payment := map[string]any{"payment_id": "00000000-0000-4000-8000-000000000011", "type": "CASH", "amount": map[string]string{"amount": "2.50", "currency": "EUR"}, "terminal_policy": "NONE"}
