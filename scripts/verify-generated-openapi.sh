...
"$generator" "$docs/api/openapi-public-v1.yaml" --output "$work/openapi-public-v1.d.ts" >/dev/null
"$generator" "$root/contracts/openapi-runtime-v1.yaml" --output "$work/openapi-runtime-v1.d.ts" >/dev/null
cmp "$work/openapi-public-v1.d.ts" "$root/contracts/generated/openapi-public-v1.d.ts" || {
