...
"$root/BeeMiniPOS/node_modules/.bin/openapi-typescript" "$work/openapi-public-v1.yaml" --output "$root/contracts/generated/openapi-public-v1.d.ts"
"$root/BeeMiniPOS/node_modules/.bin/openapi-typescript" "$root/contracts/openapi-runtime-v1.yaml" --output "$root/contracts/generated/openapi-runtime-v1.d.ts"
...
gofmt -w "$root/fiscal-backend/internal/api/response_contracts_gen.go" "$root/fiscal-backend/internal/api/response_schema_validator_gen.go" \
  "$root/beeminipos-backend/internal/api/response_contracts_gen.go" "$root/beeminipos-backend/internal/api/response_schema_validator_gen.go" \
